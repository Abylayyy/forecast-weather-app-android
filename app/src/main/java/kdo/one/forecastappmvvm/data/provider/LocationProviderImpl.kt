...
import kdo.one.forecastappmvvm.internal.LocationPermissionNotGrantedException
import kdo.one.forecastappmvvm.internal.asDeferred
...
class LocationProviderImpl(
    ...
    private fun hasCustomLocationChanged(lastWeatherLocation: Location): Boolean {
        ...
        return locationName != lastWeatherLocation.name
    }
